                    ...
                    <Row >
                        ...
                        <CardBody>
                            ...
                            <CardText>$18</CardText>
                                ...
                                <div >
                                    Units &nbsp;
                                <button class="buttonm" onClick={this.DecreaseItem}>-</button>
                                { this.state.show ? <h2 class="buttonin">{ this.state.clicks }</h2> : '0' } 
                                <button  class="buttonm" onClick={this.IncrementItem}>+</button>
                               </div>
                                <br />
                            <button class="buttonm" href="/crud">Add to Cart</button>
                            <br />
                            <br />
                            <Chips />
                        </CardBody>
